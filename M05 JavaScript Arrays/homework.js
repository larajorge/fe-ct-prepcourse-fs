...
function agregarNumeros(arrayOfNums) {
   ...
   // arrayOfNums.forEach(elemento => suma += elemento);
   // return suma;
}
...
function todosIguales(array) {
   ...
   //  return true;
    for (let i = 0; i < array.length; i++) {
       ...
       return array.every(compara => compara === elemento);
    }
}
...
function mesesDelAño(array) {
   ...
   // Tu código: (["Marzo", "diciembre", "Noviembre", "febrero", "abril", "mayo", "julio", "agosto", "septiembre", "Enero"])
   ...
   //return arrayMeses;
   //este if no evalua cuando se repite el mes
     if (arrayMeses.length === 3){  
     // este if se utiliza un include cuando los meses se repite otra forma de evaluar, 
     //lo unico es que me coloca los meses repetidos
...
function continueStatement(num) {
   ...
   for (let i = 0; i < 10; i++){
      if ( i === 5){
         ...
         suma = suma + 2;
         arrayNuevo.push(suma); //(suma,i) se coloca i para saber si la posicion 5 hace el continue.
      }
   }
   return arrayNuevo;
}
